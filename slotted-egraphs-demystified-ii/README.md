...
[^reason]: You might also have wondered why no e-classes ever contain nodes like `c2(x, x) + c3(y)`: This would correspond to a non-bijective renaming, and is thus forbidden.
